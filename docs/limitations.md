...
- The provided instrumented adapter is a scaffold/stub, not a production tensor hook; it will fail mandatory verification metadata checks and downgrade mode.
